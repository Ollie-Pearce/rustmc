...
#[no_mangle]
    #[test]
    fn type_map_tls_really_is_tls_1() {
...
#[no_mangle]
    #[test]
    fn type_map_tls_really_is_tls_take_2_1() {
        thread::spawn(|| {
...
#[no_mangle]
    #[test]
    fn many_puts_only_one_succeeds_2_1() {
        static CELL: LocalInitCell<u32> = LocalInitCell::new();
...
#[no_mangle]
    #[test]
    fn cell_tls_really_is_tls_take_2_1() {
        static CELL: LocalInitCell<Cell<u8>> = LocalInitCell::new();
