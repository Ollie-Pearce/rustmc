...
#[no_mangle]
            #[test]
            fn poll_from_multiple_executors_5() {
...
#[no_mangle]
    #[test]
    fn shared_channel_futures_are_send_2() {
...
#[no_mangle]
    #[test]
    fn dropping_shared_channel_senders_closes_channel_2() {
        let (waker, _) = new_count_waker();
        let cx = &mut Context::from_waker(&waker);
...
#[no_mangle]
    #[test]
    fn dropping_shared_channel_receivers_closes_channel_2() {
        let (sender, receiver) = oneshot_channel::<i32>();
        drop(receiver);
