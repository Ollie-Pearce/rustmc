...
#[no_mangle]
    #[test]
    fn shared_channel_futures_are_send_1() {
...
#[no_mangle]
    #[test]
    fn try_send_on_closed_channel_1() {
        let (sender, receiver) = channel::<i32>(3);
...
#[no_mangle]
    #[test]
    fn try_receive_empty_channel_1() {
...
#[no_mangle]
    #[test]
    fn try_recv_on_closed_channel_1() {
        let (sender, receiver) = channel::<i32>(3);
...
#[no_mangle]
    #[test]
    fn dropping_shared_channel_senders_closes_channel_1() {
        let (waker, _) = new_count_waker();
        let cx = &mut Context::from_waker(&waker);
...
#[no_mangle]
    #[test]
    fn dropping_shared_channel_receivers_closes_channel_1() {
        let (waker, _) = new_count_waker();
        let cx = &mut Context::from_waker(&waker);
