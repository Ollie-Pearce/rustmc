...
#[no_mangle]
        #[test]
        fn blocking_lock_test() {
            $test_sync_fn(BlockingLock);
        }

#[no_mangle]
        #[test]
        fn blocking_lock_owned_test() {
...
#[no_mangle]
        #[test]
        fn blocking_lock_owned_guards_can_be_passed_around_test() {
            let make_guard = || {
                let pool = Arc::new($lockable_type::<isize, String>::new());
...
#[no_mangle]
        #[test]
        fn test_try_lock_owned_guards_can_be_passed_around_test() {
            let make_guard = || {
                let pool = Arc::new($lockable_type::<isize, String>::new());
