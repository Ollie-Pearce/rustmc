...
#[no_mangle]
    #[test]
    fn test_mutex_arc_nested_1_1_1() {
...
#[no_mangle]
    #[test]
    fn test_mutex_arc_access_in_unwind_1_1_1() {
        let arc = Arc::new(FairMutex::new(1));
        let arc2 = arc.clone();
