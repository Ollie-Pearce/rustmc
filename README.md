...
Alternatively, the container can be built by running:

```
docker build -t rustmc .
```
...
verified in an hour (they are considered as timeouts in Fig 7), we
