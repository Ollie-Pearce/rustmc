...
/* Writes MOD as bitcode to FILENAME */
void writeBitcodeModule(llvm::Module &mod, const std::string &filename);

/* Collects module info (IDs + MDataCollection) without running the full transform pipeline */
