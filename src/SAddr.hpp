...
protected:
	...
	static constexpr Width byteMask = ((Width)1 << wordSize) - 1;
...
public:
	...
	auto getByte() const -> int { return addr & byteMask; }
	...
	/* Memory access to the whole corresponding word */
	explicit operator AAccess() const;
