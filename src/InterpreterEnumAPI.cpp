...
const std::unordered_map<std::string, InternalFunctions> internalFunNames = {
	...
	/* Memory intrinsics (lowered from llvm.memcpy/memmove/memset) */
	{"memcpy", InternalFunctions::FN_Memcpy},
	{"memmove", InternalFunctions::FN_Memmove},
	{"memset", InternalFunctions::FN_Memset},
};
