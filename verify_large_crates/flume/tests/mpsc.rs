...
#[no_mangle]
    #[test]
    fn port_gone_concurrent_shared_1() {
        let (tx, rx) = sync_channel::<i32>(0);
        let tx2 = tx.clone();
        let t = thread::spawn(move || {
            rx.recv().unwrap();
...
#[no_mangle]
    #[test]
    fn stress_recv_timeout_two_threads_1() {
        let (tx, rx) = sync_channel::<i32>(0);
...
#[no_mangle]
    #[test]
    fn stress_recv_timeout_shared_1() {
        const AMT: u32 = 1000;
        const NTHREADS: u32 = 8;
        let (tx, rx) = sync_channel::<i32>(0);
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_close_port_first_1() {
        // Simple test of closing without sending
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_close_chan_first_1() {
        // Simple test of closing without sending
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_send_port_close_1() {
        // Testing that the sender cleans up the payload if receiver is closed
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_recv_chan_close_1() {
        let (tx, rx) = sync_channel::<i32>(0);
        drop(tx);
        assert_eq!(rx.recv(), Err(RecvError));
    }
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_send_then_recv_1() {
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_try_send_open_1() {
        let (tx, rx) = sync_channel::<i32>(1);
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_try_send_closed_1() {
        let (tx, rx) = sync_channel::<i32>(0);
        drop(rx);
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_try_recv_open_1() {
        let (tx, rx) = sync_channel::<i32>(1);
        tx.send(10).unwrap();
        assert!(rx.recv() == Ok(10));
    }
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_try_recv_closed_1() {
        let (tx, rx) = sync_channel::<i32>(0);
        drop(tx);
        assert!(rx.recv().is_err());
    }
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_peek_data_1() {
        let (tx, rx) = sync_channel::<i32>(1);
        assert_eq!(rx.try_recv(), Err(TryRecvError::Empty));
        tx.send(10).unwrap();
        assert_eq!(rx.try_recv(), Ok(10));
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_peek_close_1() {
        let (tx, rx) = sync_channel::<i32>(0);
        drop(tx);
        assert_eq!(rx.try_recv(), Err(TryRecvError::Disconnected));
        assert_eq!(rx.try_recv(), Err(TryRecvError::Disconnected));
...
#[no_mangle]
    #[test]
    fn oneshot_single_thread_peek_open_1() {
        let (_tx, rx) = sync_channel::<i32>(0);
        assert_eq!(rx.try_recv(), Err(TryRecvError::Empty));
    }
...
#[no_mangle]
    #[test]
    fn oneshot_multi_task_recv_then_send_1() {
        let (tx, rx) = sync_channel::<Box<i32>>(0);
        let t = thread::spawn(move || {
            assert!(*rx.recv().unwrap() == 10);
        });
...
#[no_mangle]
    #[test]
    fn oneshot_multi_task_recv_then_close_1() {
        let (tx, rx) = sync_channel::<Box<i32>>(0);
        let t = thread::spawn(move || {
            drop(tx);
        });
...
#[no_mangle]
    #[test]
    fn oneshot_multi_thread_close_stress_1() {
        let stress_factor = stress_factor();
        let mut ts = Vec::with_capacity(stress_factor);
        for _ in 0..stress_factor {
            let (tx, rx) = sync_channel::<i32>(0);
...
#[no_mangle]
    #[test]
    fn oneshot_multi_thread_send_close_stress_1() {
        let stress_factor = stress_factor();
        let mut ts = Vec::with_capacity(stress_factor);
        for _ in 0..stress_factor {
            let (tx, rx) = sync_channel::<i32>(0);
...
#[no_mangle]
    #[test]
    fn oneshot_multi_thread_recv_close_stress_1() {
        let stress_factor = stress_factor();
        let mut ts = Vec::with_capacity(2 * stress_factor);
        for _ in 0..stress_factor {
            let (tx, rx) = sync_channel::<i32>(0);
...
#[no_mangle]
    #[test]
    fn oneshot_multi_thread_send_recv_stress_1() {
        let stress_factor = stress_factor();
        let mut ts = Vec::with_capacity(stress_factor);
        for _ in 0..stress_factor {
            let (tx, rx) = sync_channel::<Box<i32>>(0);
...
#[no_mangle]
    #[test]
    fn destroy_upgraded_shared_port_when_sender_still_active_1() {
        let (tx, rx) = sync_channel::<()>(0);
