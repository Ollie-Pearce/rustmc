...
for model in ra
do
    for cat in mixer litmus synthetic data-structures #infr saver ipr sr liveness  # helper fs lkmm lapor
    do
...
for model in ra
do
    for cat in mixer # safety liveness infr racy memory locking barriers helper # fs
    do
