...
am_libgenmc_a_OBJECTS = src/AccessFilter.$(OBJEXT) src/ASize.$(OBJEXT) \
	...
	src/Static/Transforms/FixRustAllocLTOPass.$(OBJEXT) \
	src/Static/Transforms/FoldInterpreterUnsupportedConstants.$(OBJEXT) \
...
am__depfiles_remade = src/$(DEPDIR)/ASize.Po \
	...
	src/Static/Transforms/$(DEPDIR)/FixRustAllocLTOPass.Po \
	src/Static/Transforms/$(DEPDIR)/FoldInterpreterUnsupportedConstants.Po \
...
ACLOCAL = ${SHELL} '/home/ollie/Desktop/private_mixer/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/home/ollie/Desktop/private_mixer/missing' autoconf
AUTOHEADER = ${SHELL} '/home/ollie/Desktop/private_mixer/missing' autoheader
AUTOMAKE = ${SHELL} '/home/ollie/Desktop/private_mixer/missing' automake-1.16
AWK = gawk
CC = gcc
...
CXXFLAGS = -g -O2 -I/usr/lib/llvm-18/include    -fno-exceptions -funwind-tables -D_GNU_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DOXYGEN_PAPER_SIZE = 
...
LIBOBJS = 
LIBS = -lffi -ldl  -lLLVM-18
LLVMCONFIG = /usr/bin/llvm-config
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/ollie/Desktop/private_mixer/missing' makeinfo
...
STRIP = 
VERSION = 0.10.1
abs_builddir = /home/ollie/Desktop/private_mixer
abs_srcdir = /home/ollie/Desktop/private_mixer
abs_top_builddir = /home/ollie/Desktop/private_mixer
abs_top_srcdir = /home/ollie/Desktop/private_mixer
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
...
install_sh = ${SHELL} /home/ollie/Desktop/private_mixer/install-sh
...
libgenmc_a_SOURCES = \
  ...
  src/Static/Transforms/FixRustAllocLTOPass.cpp src/Static/Transforms/FixRustAllocLTOPass.hpp \
  src/Static/Transforms/FoldInterpreterUnsupportedConstants.cpp src/Static/Transforms/FoldInterpreterUnsupportedConstants.hpp \
  src/Error.hpp \
...
include src/Static/Transforms/$(DEPDIR)/FixRustAllocLTOPass.Po # am--include-marker
include src/Static/Transforms/$(DEPDIR)/FoldInterpreterUnsupportedConstants.Po # am--include-marker
...
distclean: distclean-am
	...
	-rm -f src/Static/Transforms/$(DEPDIR)/FixRustAllocLTOPass.Po
	-rm -f src/Static/Transforms/$(DEPDIR)/FoldInterpreterUnsupportedConstants.Po
