...
-C opt-level=3 \
-C debuginfo=2 \
-C llvm-args=--inline-threshold=1000000 \
...
/usr/bin/opt-18 -S -mtriple=x86_64-unknown-linux-gnu -expand-reductions combined_old.ll -o combined_old_2.ll

#/usr/bin/opt-18 -S -passes=lower-invoke -mtriple=x86_64-unknown-linux-gnu combined_old_2.ll -o combined.ll
