...
cd $DEPDIR/rust_benchmark/thread_join
...
find thread_join/target/x86_64-unknown-linux-gnu/debug/deps -name "*.bc" > bitcode.txt
...
./genmc --program-entry-function=main --print-exec-graphs -disable-estimation --print-error-trace --disable-stop-on-system-error --transform-output=myout2.ll $DEPDIR/rust_benchmark/combined.ll
