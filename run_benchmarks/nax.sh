...
find nax/target/x86_64-unknown-linux-gnu/debug/deps -name "*.bc" > bitcode.txt
...
./genmc --program-entry-function=main --disable-estimation --print-error-trace --disable-stop-on-system-error --transform-output=myout2.ll $DEPDIR/rust_benchmark/combined.ll > $DEPDIR/run_benchmarks/nax_output.txt
