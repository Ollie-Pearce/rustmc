...
cd $DEPDIR/rust_benchmark/mixed_codebases/racy_test
...
mv racy.bc $DEPDIR/rust_benchmark/mixed_codebases/racy_test/target/x86_64-unknown-linux-gnu/debug/deps

find $DEPDIR/rust_benchmark/mixed_codebases/racy_test/target/x86_64-unknown-linux-gnu/debug/deps -name "*.bc" > bitcode.txt
...
./genmc --program-entry-function=main --disable-estimation --print-error-trace --disable-stop-on-system-error --transform-output=myout2.ll $DEPDIR/rust_benchmark/mixed_codebases/racy_test/combined.ll > $DEPDIR/run_benchmarks/racy_test_output.txt
