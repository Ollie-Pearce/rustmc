...
static GenericValue lle_X_panic(FunctionType *FT, const std::vector<GenericValue> &Args)
{
	// FIXME: should we report or raise here?
	report_fatal_error("Interpreted program panicked");
	raise(SIGABRT);
	return GenericValue();
}
...
void Interpreter::initializeExternalFunctions()
{
	...
	FuncNames["lle_X__ZN4core9panicking14panic_nounwind17h26138b2b42fa1f60E"] = lle_X_panic;
