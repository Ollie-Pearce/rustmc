...
#include "Static/Transforms/EvalAAPass.hpp"
...
#include "Static/Transforms/PromoteMemcpy.hpp"
#include "Static/Transforms/InsertUndefs.hpp"
#include "Static/Transforms/PromoteMemMove.hpp"
#include "Static/Transforms/splitRW.hpp"
			 ...
			 const std::shared_ptr<const Config> &conf) -> bool
{
		...
		basicOptsMGR.addPass(FunctionInlinerPass());
	{
		...
		PRINT(VerbosityLevel::Error) << "*** Start promote mem intrinsics.\n";
		...
		PRINT(VerbosityLevel::Error) << "*** FINISH promote mem intrinsics.\n";
